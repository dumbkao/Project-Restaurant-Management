...
public class VentanaConjuntoMesas extends JFrame {
    ...
    public VentanaConjuntoMesas(ConjuntoMesas mesas, ArrayList<Cliente> clientes) {
        super("Mesas");
        this.mesas = mesas;
    ...
    public void AgregarEventos() {
        ...
        botones.get(1).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(1).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(1), "Mesa 2", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(2).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(2).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(2), "Mesa 3", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(3).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(3).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(3), "Mesa 4", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(4).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(4).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(4), "Mesa 5", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(5).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(5).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(5), "Mesa 6", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(6).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(6).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(6), "Mesa 7", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(7).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(7).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(7), "Mesa 8", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(8).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(8).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(8), "Mesa 9", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(9).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(9).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(9), "Mesa 10", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(10).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(10).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(10), "Mesa 11", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(11).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(11).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(11), "Mesa 12", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(12).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(12).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(12), "Mesa 13", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(13).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(13).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(13), "Mesa 14", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(14).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(14).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(14), "Mesa 15", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(15).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(15).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(15), "Mesa 16", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(16).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(16).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(16), "Mesa 17", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(17).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(17).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(17), "Mesa 18", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(18).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(18).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(18), "Mesa 19", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
        botones.get(19).addActionListener((ActionEvent e) -> {
            if (mesas.getMesas().get(19).isDisponible() == true) {
                ...
                VentanaMesa vista = new VentanaMesa(mesas.getMesas().get(19), "Mesa 20", clientes);
                vista.init(mesas);
            }
            setVisible(false);
        });
